...
from .spidercnn_utils import utils as pt_utils
...
class Spidercnn_seg_fullnet(nn.Module):
    def __init__(self, cfg):
        ...
        self.K_knn = cfg.network.K_knn
        self.taylor_channel = cfg.network.taylor_channel
        self.withnor = cfg.network.withnor
        self.num_parts = cfg.num_classes
